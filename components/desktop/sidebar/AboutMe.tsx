                    ...
                    <div className="rounded-b-lg relative flex-auto p-6 bg-slate-800">
                      <div className="flex items-center">
                        <ul className="flex-1 my-4 space-y-6 text-lg leading-relaxed text-left text-slate-400">
                          ...
                          <li>📧 <span className="font-medium">Contact:</span> <a className='text-blue-400 no-underline hover:underline' href='mailto:linkhaggman@gmail.com'>Email</a>, <a className='text-blue-400 no-underline hover:underline' href='https://discord.gg/YqRJbuc5AZ'>Discord Server</a>, Discord(@linkthedev)</li>
                          <li>🌍 <span className="font-medium">Languages:</span> Svenska (Native), English (Fluent), 한국인 (TOPIK-I)</li>
                        </ul>
